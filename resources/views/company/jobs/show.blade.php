...
<section class="jumbotron text-center">
    <div class="container">
        ...
        <p>
            <a href="{{ route('company.job.destroy', $job->id) }}" class="btn btn-danger my-2">Delete</a>
            <a href="{{ route('company.job.edit', $job->id) }}" class="btn btn-secondary my-2">Edit Job</a>
        </p>
    </div>
</section>
